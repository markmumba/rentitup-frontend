      ...
      >
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            {[
              {
                icon: <TractorIcon className="h-8 w-8 text-green-600 mb-4" />,
                title: "Wide Selection",
                description: "Access to various machinery from trusted owners"
              },
              {
                icon: <Timer className="h-8 w-8 text-green-600 mb-4" />,
                title: "Real-time Booking",
                description: "Check availability and book instantly"
              },
              {
                icon: <Shield className="h-8 w-8 text-green-600 mb-4" />,
