...
function AddMachine() {
  ...
  const { mutate: addMachine, isPending } = useMutation({
    ...
    onSuccess: (response) => {
      ...
      router.push(`/machines/${id}/upload-images`);
    },
    onError: (error) => {
        ...
        <AlertDescription>
          <div className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <span className="font-medium">EXCELLENT:</span> Like new
                condition.
              </li>
              <li>
              ...
              <li>
                <span className="font-medium">FAIR:</span> Shows significant
                wear.
              </li>
              <li>
        ...
        <AlertDescription>
          <div className="space-y-2">
            ...
            <p className="italic text-sm">
              Incorrect categorization may lead to delayed listing or potential
              removal.
            </p>
          </div>
        </AlertDescription>
